...
let RegisteredUserStore = Reflux.createStore({
  listenables: [RegisteredUserActions],
...
//查询员工列表
  onQueryUser: function (filter, startPage, pageRow, flag) {
    let self = this;
    self.startPage = startPage ? startPage:0, self.pageRow = pageRow?pageRow:10,self.flag=flag ? flag :'';
    let url = this.getServiceUrl('user/getUsers');
...
module.exports = RegisteredUserStore;
